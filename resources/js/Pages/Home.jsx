    ...
    return (
        <Authenticated auth={props.auth} errors={props.errors}>
            ...
            <header className="relative flex pt-32 pb-48 sm:pt-32 sm:pb-64 lg:pb-48 px-4 bg-blue-100 w-full md:pb-40 lg:px-16 lg:pt-48 xl:pt-40 xl:pb-64 xl:h-screen md:px-8 xl:px-24 xxl:px-40">
                <div className="text-center md:text-left md:w-1/2 xxl:max-w-2xl">
                    <h1 className="text-3xl xl:text-5xl text-gray-900 font-bold leading-tight ">
                        Selamat Data Di Web Pelelangan{" "}
                        <span className="text-green-600">Bonzai</span>
                    </h1>
                    <p className="text-base xl:text-xl text-gray-600 mt-4">
                        Bonzai adalah platform pelalelangan tanaman bonsai
                        berbasis web. Disini anda akan menemukan barang dengan
                        kualitas tinggi
                    </p>

                    <p className="text-sm xl:text-base text-gray-600 mt-8">
                        Kami berfokus untuk menyediakan berbagai jenis tanaman
                        bonsai favorit anda
                    </p>
                    <a
                        href="#"
                ...
                <div className="w-full absolute bottom-0 right-0">
                    ...
                    >
                        ...
                        <g transform="translate(1950.456 5248.5)">
                            ...
                            <g
                                transform="translate(-1281.5 -5216.5)"
                                opacity="0.5"
                            >
                                <g
                            ...
                            <g
                                transform="translate(-1122.5 -5196.5)"
                                opacity="0.5"
                            >
                                <g
            ...
            <section className="bg-gray-100 flex flex-col text-center py-16 px-4 lg:px-16 md:px-8 xl:px-24 xxl:px-40">
                <div>
                ...
                <div className="mt-12 sm:flex items-start justify-between sm:-mx-2">
                    <div className="w-full bg-white rounded-lg shadow-lg py-8 px-4 sm:w-1/3 sm:mx-2 lg:mx-6">
                        <div className="h-24">
                            <img
                        ...
                        <h4 className="text-md uppercase text-gray-800 font-bold mt-12">
                            Banyak Legal
                        </h4>
                        <p className="text-base text-gray-600 mt-2">
                            Barang yang kami sediakan dijamin legal
                        </p>
                    </div>

                    <div className="w-full bg-white rounded-lg shadow-lg py-8 px-4 mt-6 sm:mt-0 sm:w-1/3 sm:mx-2 lg:mx-6">
                        <div className="h-24">
                            <img
                                src="https://bytewebster.com/img/logo.png"
                                alt=""
                        ...
                        <p className="text-base text-gray-600 mt-2">
                            Bonsai dengan kualitas terbaik
                        </p>
                    </div>
                ...
                <div className="mt-40 w-full sm:max-w-2xl sm:mx-auto">
                    <p className="text-md font-bold text-gray-900 lg:text-xl">
                        “Kami bertujuan untuk menyediakan platform pelelangan
                        online yang terpercaya dan nyaman”
                    </p>
                    <p className="text-blue-500 font-bold mt-4">Developer</p>
                </div>
            </section>

            <section className="bg-blue-500 flex flex-col py-12 px-4 text-center lg:px-16 md:px-8 xl:px-24 xxl:px-40">
                <div>
                    <h2 className="text-xl font-bold text-white lg:text-3xl ">
                        Syarat dan Ketentuan Pelelangan
                    </h2>
                </div>
                ...
                <div className="sm:flex items-center">
                    <div className="mt-8 sm:w-1/2 sm:text-left">
                        ...
                        <p className="text-base text-white mt-2">
                            Syarat dan ketentuan yang tertera berlaku untuk
                            semua barang. <br />
                            Pelanggaran terhadap syarat dan ketentuan akan
                            diberikan sanksi
                        </p>
                    </div>
            ...
            <section className="text-center bg-white px-4 py-12 lg:px-16 md:px-8 xl:px-24 xxl:px-40">
                <div>
                    <h2 className="text-xl font-bold text-gray-900 lg:text-3xl ">
                        Butuh Bantuan?
                    </h2>
                    <p className="w-full lg:w-1/2 mx-auto text-base text-gray-600 mt-6">
                        Hubungi kami jika anda memiliki pertanyaan mengenai
                        pelelangan ini
                    </p>
                    <a href="#" className="block text-xl text-blue-500 mt-4">
                        support@bonzai.com
                    </a>
                </div>
            </section>
